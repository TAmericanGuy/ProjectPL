...
export default function App() {
  ...
  const handleOpenRelease = (vehicle) => {
    setReleaseForm((prev) => ({
      ...prev,
      vinFull: vehicle?.vinFull ?? "",
      error: "",
    }));
            ...
            {selectedSpotId && assignments[selectedSpotId] ? (
              <div className="selected-vehicle-body">
                ...
                <button
                  ...
                  onClick={() =>
                    handleOpenRelease(vehiclesById[assignments[selectedSpotId]])
                  }
                >
                  Release vehicle
                </button>
            ...
            <div className="modal-body">
              ...
              <div className="modal-actions">
                ...
                <button
                  className="ghost-btn ghost-btn--danger"
                  type="button"
                  onClick={() => handleOpenRelease(selectedVehicle)}
                >
                  Release vehicle
                </button>
